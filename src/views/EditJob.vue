<template>
    <form @submit.prevent="handleSubmit">
        ...
        <input type="text" v-model="jobData.company.companyId" id="companyId" readonly>

        <label for="companyName">Company Name:</label>
        <input type="text" v-model="jobData.company.companyName" id="companyName" readonly>
        ...
        <input type="text" v-model="jobData.dueDate" id="dueDate" required>
  ...
  export default {
    ...
    mounted() {
      fetch(this.uri)
        .then(res => res.json())
        .then(data => {
            this.jobData.company.companyId = data.company.companyId
            this.jobData.company.companyName = data.company.companyName
            this.jobData.jobTitle = data.jobTitle
            this.jobData.skills = data.skills
            this.jobData.formattedAddress = data.formattedAddress
            this.jobData.salary = data.salary
            this.jobData.dueDate = data.dueDate
            this.jobData.description = data.description
